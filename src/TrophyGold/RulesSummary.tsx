...
const RulesSummary = () => {
  ...
  return (
    <Box>
      <Heading fontFamily="Roboto Slab" id="SRD" mb={4}>
        How to Play
      </Heading>
      <Divider />
      <Heading fontFamily="Roboto Slab" mt={6} mb={4}>
        Risk Roll
      </Heading>
      <Text mb={4}>
      ...
      <Heading fontFamily="Roboto Slab" id="devilsBargain" mt={6} mb={4}>
        Devil&apos;s Bargains
      </Heading>
      <Text mb={4}>
      ...
      <Heading fontFamily="Roboto Slab" id="ruinRoll" mt={6} mb={4}>
        Ruin Roll
      </Heading>
      <Text mb={4}>
